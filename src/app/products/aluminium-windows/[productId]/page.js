...
const AluminiumProductsPanel = [
  // categories
  {
    ...
    keywords: [
      ...
      "luxury corner windows",
      "architectural glass windows",
    ],
    description:
      "Enhance your space with frameless Glass-to-Glass Corner Windows. Offering panoramic views, energy efficiency & durability for modern architecture.",
    features: [
  ...
  },
  {
    ...
    title: "Premium Aluminium Casement Windows | Durable & Stylish",
    ...
    keywords: [
      ...
      "Durable Casement Window Design",
      "Custom Casement Windows",
      "Weather Resistant Casement Windows",
      "Best Casement Window Manufacturer",
      "Ventilated Aluminium Windows",
      "Secure Casement Window Locking System",
    ],
    series: [
      {
        seriesName: "Grant",
    ...
    description:
      "Discover high-quality aluminium casement windows with superior ventilation, energy efficiency, and modern design. Perfect for homes, offices, and commercial spaces.",
    features: [
  ...
  },
  {
    ...
    keywords: [
      ...
      "Luxury Glass Balustrades",
      "Premium Glass Railing Systems",
      "High-End Glass Railings",
      "Custom Glass Railings",
      "Modern Glass Railing Design",
      "Glass Railings for Villas",
      "Architectural Glass Railings",
      "Durable Glass Balustrades",
      "Best Glass Railing Manufacturer",
    ],
    series: [
      {
        seriesName: "Grant",
        products: [
          {
            ...
            description:
              "Explore premium frameless glass railings for modern spaces. Sleek, durable, and stylish balustrades designed for luxury homes, villas, and architectural projects.",
            features: [
              "In case of IG, consult with our technician for size and performance",
              "Pleated insect screen available",
              "Glazing finish options: 8 - 13.52mm, 28 - 31.52mm, Other glass (Sealant)",
  ...
  },
  {
    ...
    title: "Modern Aluminium Fixed Windows | Energy-Efficient & Stylish",
    ...
    keywords: [
      ...
      "Premium Aluminium Windows",
      "Durable Fixed Window Design",
      "Custom Fixed Windows",
      "Weather Resistant Fixed Windows",
      "Best Fixed Window Manufacturer",
      "Natural Light Aluminium Windows",
      "Secure Fixed Window Installation",
    ],
    series: [
      {
        seriesName: "Grant",
    ...
    description:
      "High-performance aluminium fixed windows designed for maximum natural light, energy efficiency, and durability. Perfect for modern homes and commercial spaces.",
    features: [
  ...
  },
  {
    ...
    title: "Modern Vertical Awning Windows for Stylish Homes",
    ...
    description:
      "Enhance airflow & aesthetics with durable, energy-efficient vertical awning windows. Ideal for homes & commercial spaces, offering security & weather resistance.",
    features: [
      "Energy-Efficient: Keeps interiors cool in summer and warm in winter.",
      "Durable & Weather-Resistant: Withstands extreme weather.",
      "Low Maintenance: Easy to clean and requires minimal upkeep.",
  ...
  },
  {
    ...
    title: "Glass-to-Glass Corner Windows - Modern & Sleek Design",
    ...
    description:
      "Maximize natural light with frameless Glass-to-Glass Corner Windows. Durable, weather-resistant & energy-efficient for modern spaces.",
    features: [
