...
// export const AluminiumProductsPanel = [
//   {
...
// import normal from "../../../assets/AluminiumProduct/AluminiumCategories/VerticalSlide/normal.png";
export const AluminiumProductsPanel = [
  // categories
  {
    id: "awning-windows",
...
export default function ProductPage({ params }) {
  ...
  const fetchedId = pathname.substring(pathname.lastIndexOf("/") + 1);
