...
export const metadata = {
  title:
    "Selective System: Glass Railing | Balcony Glass Railing  | glass railing systems",
  description:
  ...
  icon: "./favicon.ico",
  content: "https://selectivesystems.in/products/railings",
  openGraph: {
    type: "website",
  },
  url: "https://selectivesystems.in/products/railings",
};

export default function page() {
  return <GlassRailings />;
}
