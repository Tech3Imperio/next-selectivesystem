...
import Link from "next/link"; // requires a loader
...
import { FadeUp } from "../componets/utility/animation";
    ...
    <main className="relative">
      ...
      >
        {sliderItems.map((item, index) => (
          <div key={index} className="relative w-full h-full">
            ...
            <div className="content absolute top-[20%] text-[0.700rem] w-[100%] left-[60%] transform -translate-x-1/2 pr-[30%] box-border text-[#e4e4e4] text-shadow harmony-regular md:top-[20%] md:text-sm lg:top-[28%] lg:text-2xl xl:top-[20%] xl:text-base">
              <motion.div
                className="title text-base harmony-regular font-bold leading-[1.3em] md:text-3xl lg:text-4xl"
              ...
              <motion.div
                className="type text-sm py-1 font-bold harmony-regular leading-[1.3em] text-[#14ff72cb] md:text-3xl lg:text-3xl"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5 }}
              >
        ...
        <div className="container mx-auto">
            ...
            <div className="lg:w-1/2 flex flex-col justify-center font-raleway ">
              <div className="max-w-xl mx-auto">
                ...
                <motion.h1
                  ...
                  whileInView="visible"
                  viewport={{ once: true }}
                  className="text-2xl ml-4 font-bold mb-6 harmony-regular text-primary md:text-3xl lg:text-3xl lg:ml-10 xl:text-4xl xl:w-[48rem] xl:-ml-24 xl:-mt-[2rem]"
                >
                  About Us
                </motion.h1>
                <motion.p
                  ...
                  whileInView="visible"
                  viewport={{ once: true }}
                  className="mb-4 text-[0.700rem] px-4 md:text-base harmony-extralight md:w-[49rem] lg:text-sm lg:w-[33rem] lg:px-8  xl:w-[52rem] xl:-ml-32 xl4:w-[56rem] xl4:text-base"
                >
                ...
                <motion.p
                  ...
                  whileInView="visible"
                  viewport={{ once: true }}
                  className="mb-4 text-[0.700rem] px-4 harmony-extralight md:text-base md:w-[48.2rem] lg:text-sm lg:w-[33rem] lg:px-8 xl:w-[142%] xl:-ml-32 xl4:text-base xl4:w-[159%]"
                >
          ...
          >
            <div className=" lg:flex-row">
              <p className="mb-2 text-[0.700rem] harmony-extralight lg:mb-0 px-4 md:text-base md:w-[48.2rem] lg:text-sm lg:w-full xl:w-auto xl:mt-8 xl4:text-base">
              ...
              <br />
              <p className="mb-6 text-[0.700rem]  harmony-extralight px-4 lg:mb-0 md:text-base md:w-[48.2rem] lg:text-sm lg:w-full xl:w-auto xl4:text-base">
            ...
            {/* <div className=" ml-6 mt-12 justify-center">
              <Link
                to=""
                className="btn theme-btn-2 btn-effect-1 bg-secondary text-black hover:bg-primary hover:text-white harmony-regular py-2 px-4 rounded-full"
              >
                About Us
              </Link>
            </div> */}
      ...
      <div className=" -mt-[4rem] relative flex items-center bg-gray-800 h-[33rem]">
        ...
        <div className="container mx-auto flex flex-col items-center text-center z-10 ">
          <div className=" mb-8">
            <h6 className="text-sm w-[13rem] text-secondary harmony-regular md:text-sm md:w-auto lg:text-base lg:w-full xl:text-xl xl:w-auto">
              If you have any inquiries, please feel free to reach out.
            </h6>
            <h1 className="text-base py-2 text-primary harmony-regular md:text-2xl lg:text-2xl xl:text-4xl">
              9372593981
            </h1>
          </div>
          <div className="flex gap-5 md:gap-10 lg:gap-12 xl:gap-14 harmony-regular">
            <a
              href="tel: 9372593981"
