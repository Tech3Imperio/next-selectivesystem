...
const mainNavItems = [
  ...
  { name: "Careers", type: "link", href: "/careers" },
];
...
export default function HamburgerMenu() {
  ...
  return (
    <>
      <button
        className="relative z-50 py-2 px-8 text-gray-900 dark:text-gray-100 rounded-full shadow-md"
      ...
      {isOpen && (
        ...
        >
          <div className="absolute h-min top-5 right-3 w-56 rounded-lg   bg-white dark:bg-black z-100 hamburger-menu">
            <NestedNavigation
              items={mainNavItems}
