...
import GlassRailingProduct from "./layout";
export const metadata = {
  title:
    "Selective Systems: Premium Aluminium Windows | Glass Railing in Mumbai | Tostem Partner ",
  description:
  ...
  alternates: {
    canonical: "/components/GlassRailing",
  },
};

export default function page() {
  return <GlassRailingProduct />;
}
